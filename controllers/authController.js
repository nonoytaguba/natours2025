...
exports.signup = catchAsync(async (req, res, next) => {
    ...
    //     passwordConfirm: req.body.paswordConfirm
    // })
...
exports.protect = catchAsync( async (req, res, next) => {
    ...
    if(!token){
        return next(new AppError('you are not logged in! Pleasee log in to get access.', 401))
    }
...
user.passwordConfirm = req.body.passwordConfirm
await user.save();
// User.findByIdAndUpdate will NOT work as intended! lesson 138 timestamp 8:26
