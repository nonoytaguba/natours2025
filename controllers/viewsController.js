...
exports.alerts = (req, res, next) => {
    ...
    if(alert === 'booking')
        res.locals.alert = 'Your booking was successful! Please check your email for a confirmation. If your bookng doesn\'t show up here immediately, please come back later. ';
    next();
}
